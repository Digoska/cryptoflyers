...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(14228780);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(14230396);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.evtsExt__ScoreCounter__ScoreCounter.ScoreCounter.prototype.SetScoreContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScoreCounter__ScoreCounter.ScoreCounter.prototype.SetScoreContext.GDObjectObjects1[i]._setScore(eventsFunctionContext.getArgument("Value"));
}
}}

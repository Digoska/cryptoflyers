...
gdjs.GameCode.GDNewLeaderboardDialogObjects1= [];
gdjs.GameCode.GDNewLeaderboardDialogObjects2= [];
gdjs.GameCode.GDNewLeaderboardDialogObjects3= [];
gdjs.GameCode.GDNewLeaderboardDialogObjects4= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11260396);
}
}
if (isConditionTrue_0) {
...
{runtimeScene.getScene().getVariables().getFromIndex(0).setString("GamePlaying");
    ...
    gdjs.GameCode.GDNewSprite2Objects1[i].hide();
}
}}
...
};gdjs.GameCode.asyncCallback10659372 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback10659372(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11543444);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9180380);
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "pipe_spawn");
}}
...
};gdjs.GameCode.asyncCallback9054668 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GameCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.GameCode.asyncCallback9054668(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11090564);
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.GameCode.GDBackgroundObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDBackgroundObjects1[i].hide();
}
}{for(var i = 0, len = gdjs.GameCode.GDNewSprite2Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDNewSprite2Objects1[i].hide(false);
}
}}
...
gdjs.GameCode.GDNewLeaderboardDialogObjects1.length = 0;
gdjs.GameCode.GDNewLeaderboardDialogObjects2.length = 0;
gdjs.GameCode.GDNewLeaderboardDialogObjects3.length = 0;
gdjs.GameCode.GDNewLeaderboardDialogObjects4.length = 0;

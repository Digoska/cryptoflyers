...
{for(var i = 0, len = gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setDisplayedValue(gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getDisplayedValue() + (eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getSpeed() * gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene) * gdjs.evtTools.camera.getLayerTimeScale(runtimeScene, (gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.doStepPreEventsContext.GDObjectObjects1[i].getLayer()))));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.SetValueContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.SetValueContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setDisplayedValue(eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getCounterValue());
}
}{for(var i = 0, len = gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.SetValueContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.SetValueContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setCounterValue(eventsFunctionContext.getArgument("Value"));
}
}{for(var i = 0, len = gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.SetValueContext.GDObjectObjects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.ResetDisplayedValueContext.GDObjectObjects1);
{for(var i = 0, len = gdjs.evtsExt__ScoreCounter__RollingCounter.RollingCounter.prototype.ResetDisplayedValueContext.GDObjectObjects1.length ;i < len;++i) {
